                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success">Business</span>
                                            </td>
                                            <td><a class="btn btn-outline-secondary btn-sm edit" title="Editar">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a> 
                                                | 
                                                <a class="btn btn-outline-secondary btn-sm edit" title="Deletar">
                                        ...
                                        <tr>
                                            ...
                                            <td>Jacob</td>
                                            <td>xyz@Example.com</td>
                                            <td><span class="badge bg-warning">Personal</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">3</th>
                                            <td>Larry</td>
                                            <td>xyz@Example.com</td>
                                            <td><span class="badge bg-danger">Disabled</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
