                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    @if (count($Servicos)==0)
                                    <h2>Não tem Nenhum Serviço Cadastrado</h2>
                                    @else
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$servico->nome}}</td>
                                            <td>{{$servico->preco}}</td>
                                            <td><span>{{$servico->descricao}}</span>
                                            </td>
                                            <td><a href="{{Route('Servico.Editar', $servico->id)}}" class="btn btn-outline-secondary btn-sm edit" title="Editar">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                |
                                                <a href="{{Route('Servico.Eliminar', $servico->id)}}" class="btn btn-outline-secondary btn-sm edit" title="Deletar">
